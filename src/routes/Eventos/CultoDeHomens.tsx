...
const CultoDeHomens: React.FC = () => {
  return (
    <div className="min-h-screen">
      ...
      <h1 className="text-4xl font-bold my-12 text-center">Congresso OnFire</h1>
      <div className="flex justify-center">
        <div className="bg-white p-8 sm:rounded-lg shadow-lg max-w-5xl w-full">
          <h2 className="text-3xl font-semibold mb-4">O que é o Congresso OnFire?</h2>
          <p className="mb-6 text-lg text-gray-700">
            Lorem ipsum dolor sit, amet consectetur adipisicing elit. Dolores tenetur maxime eligendi odio cumque nemo saepe quas repudiandae
             est at error optio veritatis iure voluptates, magnam reiciendis. Perspiciatis molestiae consectetur vel accusantium recusandae?
              Alias cupiditate sequi eos dolore blanditiis itaque ratione labore quidem? Adipisci nam sapiente facilis. Modi illum eveniet,
               cumque dolorum adipisci accusantium nam? Officia fuga dignissimos nemo exercitationem temporibus soluta, esse voluptatem facere,
                consequatur dolore repudiandae autem ipsam modi, officiis quia quod omnis! Voluptatibus fugiat impedit earum nihil delectus,
          </p>
