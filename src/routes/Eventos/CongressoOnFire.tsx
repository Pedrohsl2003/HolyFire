...
const CongressoOnFire: React.FC = () => {
  return (
      ...
      <div className="flex justify-center">
        <div className="bg-white p-8 sm:rounded-lg shadow-lg max-w-5xl w-full">
          ...
          <p className="mb-6 text-lg text-gray-700">
            A Conferência Céu na Terra é um evento especial voltado para os jovens, com o tema "Céu na Terra". 
            É uma oportunidade única de experimentar um poderoso avivamento, onde passamos o dia na igreja sendo ministrados 
            e conectando-nos uns com os outros. Este é um momento incrível de união entre os jovens, 
            em um ambiente onde a presença do Senhor é sentida intensamente e o Espírito Santo incendeia nossos corações.
          </p>
...
export default CongressoOnFire;
